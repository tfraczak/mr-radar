...
export const THEMES = ['system', 'slate', 'bubblegum', 'pine', 'pizza', 'seafoam', 'quarry', 'lilac', 'sunflower', 'meringue', 'oatmeal', 'coral', 'glacier', 'moss', 'cocoa', 'peach', 'charcoal', 'parchment', 'storm', 'mist', 'lemonade', 'matcha', 'bubbles', 'juniper', 'harbor', 'rain', 'pumpkin', 'mulberry', 'watermelon', 'mineral', 'olivine'] as const;
